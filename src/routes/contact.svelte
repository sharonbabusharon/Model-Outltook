...
<div class="main_container" id="contact_form_div">
  <div class="form">
    ...
    <a target="_blank" href="https://wa.me/917994844456"><button style="margin-top: 28px;" class="submit green" type="submit">Chat with us<i style="margin-left: 10px;" class="fa-brands fa-whatsapp"></i></button></a>
  </div>
  </div>
